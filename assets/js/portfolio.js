...
const rolePresets = Object.freeze({
  general: {
    ...
    lede: 'Full-stack and applied AI engineer turning ambiguous needs into reliable products, grounded RAG/search systems, APIs, data pipelines, and human-in-the-loop workflows.',
    note: 'Showing a balanced view of product engineering, applied AI, backend systems, and data platforms.',
    cta: 'See selected work',
    ctaTarget: '#work',
    workHeading: 'Products with a point of view.',
    workIntro: 'Public, inspectable systems spanning grounded AI, secure integrations, and interactive product engineering.',
  ...
  fullstack: {
    ...
    workIntro: 'Inspect full-stack systems that connect responsive interfaces, backend services, data stores, authentication, real-time updates, testing, and deployment.',
    experienceHeading: 'Engineering across the stack.',
    ...
    matches: ['lume', 'filedrop', 'commerce'],
  },
  ai: {
    short: 'Applied AI',
  ...
  data: {
    ...
    workIntro: 'Public systems showing document ingestion, search, structured storage, API integration, and interfaces that turn complex information into usable workflows.',
  ...
  frontend: {
    ...
    workIntro: 'Explore responsive product interfaces spanning meeting intelligence, workflow tools, and an interactive Three.js commerce configurator.',
    experienceHeading: 'Frontend work grounded in real workflows.',
    experienceIntro: 'Building React interfaces and collaborative tools around enterprise data, educator feedback, research workflows, and thousands of users.',
  ...
  solutions: {
    ...
    lede: 'Solutions engineer translating stakeholder needs into rapid prototypes, API and data integrations, tested workflows, delivery documentation, and production-ready handoffs.',
    ...
    workIntro: 'See products built from concrete user problems: meeting context, secure cross-device handoffs, and configurable commerce experiences.',
